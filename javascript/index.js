...
// Funcion que imprima cards de paises con forEach

function printCards(paises) {
    ...
    <section class="cards">
            <div class="card__info">
                ...
                <p class="card__name"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                    ...
                    ${pais.name.common}</p>
                <p class="card__timeZone"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                        fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                        <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
                        <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z" />
                    </svg>${pais.timezones}</p>
                <p class="card__map"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                        <path
                            d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                    </svg><a href="${pais.maps.googleMaps}" target="_blank">City Map</a>
                </p>
            </div>
...
// function paintDomWithPaises(paises) {
//   const tagToUpdate = document.getElementById("root")
...
//     title.textContent = pais.name.official
//     fragment.appendChild(title)
//   })
//   tagToUpdate.appendChild(fragment)
// }

// paintDomWithPaises(paises)
